<?php
	...
	class JetRails_Cloudflare_Block_Adminhtml_Dashboard_Edit_Tab_Speed extends Mage_Adminhtml_Block_Widget_Form {
	    ...
	    protected function _prepareForm () {
				...
				$fieldset = $form->addFieldset (
					...
					array ( "legend" => Mage::helper ("cloudflare")->__("General Configuration") )
				);
