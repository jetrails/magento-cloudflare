<?php
	...
	class JetRails_Cloudflare_Model_Adminhtml_Api_Caching_AlwaysOnline extends Mage_Core_Model_Abstract {

		public function getValue () {
			$zoneId = Mage::getModel ("cloudflare/api_overview_configuration")->getZoneId ();
			$endpoint = sprintf ( "zones/%s/settings/always_online", $zoneId );
